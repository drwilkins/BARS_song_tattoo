...
for_vid <- dynaSpec::prep_static_ggspectro(soundFile="BARS_concat_song_4_tat.wav",xLim=6.26,yLim = c(1.5,7),ampTrans = 4,savePNG = T,specWidth = 13, specHeight = 2,ovlp = 90,colbins=50,crop = 6.26,onlyPlotSpec = F,bgFlood = T)
